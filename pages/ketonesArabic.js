...
import moment from 'moment';
  ...
  const ketonesAR = ({ navigation, route }) =>{
...
//-------------------------------
    return (
      ...
      <View style={styles.footer}>
        {AccType == 'Patient Account' ? <Text style={styles.title}>الخطوة 4 من 7: معلومات مراقبة الجلوكوز والكيتونات{'\n'}</Text> :
        <Text style={styles.title}>الخطوة 3 من 6: معلومات مراقبة الجلوكوز والكيتونات{'\n'}</Text>}
