...
import react from 'react';
  ...
  const warning = ({ navigation, route }) =>{
    ...
    return (
      ...
      <Text style={styles.text_footer}>You can not use the application and create an account unless you agree to the disclaimer.{'\n'}</Text>
      ...
      <Text>{AccountT}</Text>
        ...
        <TouchableOpacity onPress={()=>navigation.navigate('login', AccountT)}>
                ...
                >
                    <Text style={styles.titleB}>Ok</Text>
