    ...
    <LinearGradient colors={['#AABED8', '#fff']} style={styles.container}>
      ...
      <ScrollView style={styles.contView}>
        ...
        <Text style={styles.inpTxt}>
          Your blood glucose level has normalized.{'\n'}
          You don’t need to take a snack unless: {'\n'}- It is bedtime{'\n'}-
          This low glucose level happened during sleep or after exercise{'\n'}-
          You had recurrent hypoglycemia throughout this day{'\n'}- You took
