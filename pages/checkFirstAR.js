  ...
  useEffect(() => {
    ...
    const checkFirstTime = () => {
      if (dateIsFirst == currentDate){
        navigation.navigate('recheckexerciseAR');
      }
      else {
          if (flags == '1'){//if exerciseAR message flag = true, and first time to enter exerciseAR tab in this day
            navigation.navigate('exerciseAR');
          }
              ...
              if (month == months){
                ...
                if (day + 13 <= date){//two week ago
                  ...
                  if (checkCase1 == '1' || checkCase2 == '1' || checkCase3 == '1' || checkCase4 == '1'){
                    ...
                    navigation.navigate('exerciseAR3');
                  }
                }
