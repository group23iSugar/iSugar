...
var calcMethod = [
  ...
  const icrFastingAR = ({ navigation, route }) =>{
...
resizeMode="stretch"/>
      ...
      <Text style={{fontSize: 20, fontWeight: 'bold', color: '#05375a', marginBottom: 0}}>معامل الكاربوهيدرات</Text>
      <ScrollView>
