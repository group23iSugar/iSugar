...
const logIn = ({navigation}) => {
         ...
         db.transaction( (tx) => {
           tx.executeSql(
            'INSERT INTO icrInterval (UserID, fromTime, toTime, ICR) VALUES (?,?,?,?)',
              [uID, fromTime1[i], toTime1[i], ICR1[i] ]
          );
 ...
 //To find sliding scale id from local database
   ...
   const onlineDB = () => {
    ...
    var InsertAPIURL = "https://isugarserver.com/AuthenticateUserAcc.php";   //API to  signup
...
.catch((error)=>{
 ...
 const onlineDBProfile = () => {
   ...
   //var InsertAPIURL = "https://isugarserver.com/AuthenticatePatientProfile.php";   //API to  signup
   var InsertAPIURL = "https://isugarserver.com/isugar/AuthenticatePatientProfile.php";
 ...
 const onlineDBPen = () => {
   ...
   //var InsertAPIURL = "https://isugarserver.com/AuthenticateInsulinPen.php";   //API to  signup
   var InsertAPIURL = "https://isugarserver.com/isugar/AuthenticateInsulinPen.php";
 ...
 const onlineDBOther = () => {
   ...
   //var InsertAPIURL = "https://isugarserver.com/AuthenticateInsulinOther.php";   //API to  signup
   var InsertAPIURL = "https://isugarserver.com/isugar/AuthenticateInsulinOther.php";
 ...
 const onlineDBISF = () => {
   ...
   //var InsertAPIURL = "https://isugarserver.com/AuthenticateISFInterval2.php";   //API to  signup
   var InsertAPIURL = "https://isugarserver.com/isugar/AuthenticateISFInterval2.php";
   var headers = {
     'Accept': 'application/json',
     'Content-Type': 'application/json'
   };
 ...
 const onlineDBICRinter = () => {
  ...
  // var InsertAPIURL = "https://isugarserver.com/AuthenticateICRInterval2.php";   //API to  signup
   var InsertAPIURL = "https://isugarserver.com/isugar/AuthenticateICRInterval2.php";
 ...
 const onlineDBSSInterval = () => {
  ...
  // var InsertAPIURL = "https://isugarserver.com/AuthenticateSlidingScaleInterval2.php";   //API to  signup
   var InsertAPIURL = "https://isugarserver.com/isugar/AuthenticateSlidingScaleInterval2.php";
 ...
 const onlineDB_BGLevel = () => {
   ...
   //var InsertAPIURL = "https://isugarserver.com/AuthenticateBGLevelInsulin2.php";   //API to  signup
   var InsertAPIURL = "https://isugarserver.com/isugar/AuthenticateBGLevelInsulin2.php";
 ...
 const onlineDBTakenInsulin = () => {
   ...
   //var InsertAPIURL = "https://isugarserver.com/AuthenticateTakenInsulin.php";   //API to  signup
   var InsertAPIURL = "https://isugarserver.com/isugar/AuthenticateTakenInsulin.php";
 ...
 const onlineDBPlannedEx = () => {
   ...
   //var InsertAPIURL = "https://isugarserver.com/AuthenticatePlannedEx.php";   //API to  signup
   var InsertAPIURL = "https://isugarserver.com/isugar/AuthenticatePlannedEx.php";
   var headers = {
     'Accept': 'application/json',
     'Content-Type': 'application/json'
   };
 ...
 const onlineDBPreEx = () => {
   ...
   //var InsertAPIURL = "https://isugarserver.com/AuthenticatePreviousEx.php";   //API to  signup
   var InsertAPIURL = "https://isugarserver.com/isugar/AuthenticatePreviousEx.php";
