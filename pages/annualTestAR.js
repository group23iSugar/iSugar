       ...
       <Text style={styles.Annual}>الفحوصات السنوية</Text>
        <View style={styles.footer}>
          ...
          <ScrollView>
            ...
            <View style={styles.action}>
              <View><Text style={styles.internalText}>تاريخ فحص الغدة الكظرية  </Text></View>
              <View style={styles.dateB}>
            ...
            <View style={styles.action}>
              <View><Text style={styles.internalText}> تاريخ فحص حساسية القمح (السيلياك) </Text></View>
              <View style={styles.dateB}>
            ...
            <View style={styles.action}>
              <View><Text style={styles.internalText}> تاريخ فحص الكلى </Text></View>
              <View style={styles.dateB}>
            ...
            <View style={styles.action}>
              <View><Text style={styles.internalText}>تاريح فحص الدهون  </Text></View>
              <View style={styles.dateB}>
            ...
            <View style={styles.action}>
              <View><Text style={styles.internalText}> تاريخ فحص ضغط الدم  </Text></View>
              <View style={styles.dateB}>
            ...
            <View style={styles.action}>
              <View><Text style={styles.internalText}>تاريح فحص العيون  </Text></View>
              <View style={styles.dateB}>
            ...
            <View style={styles.action}>
              <Text style={styles.inpTxt}>نتيجة الكشف </Text>
              <Picker
               ...
               style= {styles.picker}
               >
                  <Picker.Item label= "يوجد اعتلال في الشبكية" value="0" />
                  <Picker.Item label= "لا يوجد اعتلال في الشبكية" value="1" />
              </Picker>
            </View>
            <View style={styles.action}>
              <View><Text style={styles.internalText}>تاريخ آخر تطعيم للإنفلونزا  </Text></View>
              <View style={styles.dateB}>
            ...
            <View style={styles.action}>
              <View><Text style={styles.internalText}>تاريخ آخر زيارة لطبيب الأسنان</Text></View>
              <View style={styles.dateB}>
