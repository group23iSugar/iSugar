...
import react from 'react';
  ...
  const personalInfoAR = ({ navigation, route }) =>{
...
<Text style={styles.text_footer}>{getAge(dateOfBirth)} عاما</Text>
</View>
</View>
...
(<View style={styles.action}>
  ...
  <View style={styles.field}>
  <Text style={styles.text_footer}>{getBMI()} كجم / م2</Text>
  </View>
  </View>) : null }
...
<Text style={styles.text_footer}>التاريخ</Text>
<View style={styles.dateB}>
