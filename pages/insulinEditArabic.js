...
const handleUpdateNormal = () => { // user only changed the values without regimen
 ...
 const onlineOtherDB = (type, dose, time) => {
  if (AccType == 'Patient Account'){
    var InsertAPIURL = "http://192.168.12.1/isugar/insulin_Other.php";   
...
const oldOnlineOtherDB = (type, dose, time) => {
  if (AccType == 'Patient Account'){
    var InsertAPIURL = "http://192.168.12.1/isugar/updateInsulinOther.php";   //API to  signup
...
const oldOnlinePenDB = (type, halfull) => {
  if (AccType == 'Patient Account'){
    var InsertAPIURL = "http://192.168.12.1/isugar/insulinPenUpdate.php";   //API to  signup
