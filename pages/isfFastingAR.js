  ...
  const localISF = () => {
    ...
    return (
      ...
      <View style={styles.footer}>
       <Text style={styles.title}>معامل حساسية الانسولين {'\n'}</Text>
...
<View style={styles.actionB}>
              <Text style={styles.text_footer}>وقت بداية التصحيح</Text>
             <Text style={styles.text_footer}>{isfInterval == '0' ? 'All Day' : 'Specific Hours'}</Text>

</View>
{isfInterval == '0' ? (<View style={styles.actionB}>

 <Text style={styles.text_footer}>معامل حساسية الإنسولين (ISF):</Text>
 <TextInput
...
<Text style={styles.text_footer}>الهدف</Text>
<TextInput
            keyboardType="decimal-pad"
            defaultValue={tBGP + ''}
...
{isfInterval == '0' ? (<View style={styles.actionB}>
<Text style={styles.text_footer}>بداية التصحيح:</Text>
<TextInput
            keyboardType="decimal-pad"
            defaultValue={sBGP + ''}
...
: null}
  {isfInterval == '1' ? hours.length > 0 ? ( (<View style={{alignItems:'center'}}>
             ...
             style={{fontSize: 17, color: 'grey', alignItems: 'flex-start'}} >
               ...
               style={{fontSize: 17, color: 'grey'}} >
                     ...
                     {showTo && (
                      ...
                      <Text style={styles.innerTitle}>معامل حساسيةالانسولين: {index} </Text>
                      <TextInput
          ...
          />
          <TouchableOpacity
          onPress={()=>addISF()}><Text style={{fontSize: 15, color: '#05375a', textDecorationLine: 'underline' }} >اضافة فترة</Text></TouchableOpacity>
