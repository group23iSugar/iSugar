...
const tableText = function(BG, ketonesSource, ketonesLevel, isMeal, insulinType, flags){
    ...
    var recommendation = '';
    var caseNO = '';
    var ifMealTime = '• Take your insulin dose as usual for your meal/snack and for correction if needed based on your current blood glucose reading.'; //displayes message if the its the meal time.
    var rapid = '• using your rapid acting insulin pen';
    ...
    if (caseNO == '6'){
        switch (caseNO == '6'){
            case level < 0.6:
                console.log('K');
                if (Meal != 'No'){
                    recommendation = '• No extra insulin required for illness at this time.' + '\n' + '• Encourage fluids intake (At least 100ml every hour)' + '\n' + '• Re-check your blood glucose & Ketone level in 4 hours or sooner if you have hypoglycemia symptoms' + '\n' + '• If you have vomiting & it is persistent, go to ER';
                     } else {
                         recommendation = '• No extra insulin required for illness at this time.' + '\n' + '• Encourage fluids intake (At least 100ml every hour)' + '\n' + '• Re-check your blood glucose & Ketone level in 4 hours or sooner if you have hypoglycemia symptoms' + '\n' + '• If you have vomiting & it is persistent, go to ER';
                     }
                     finalRecommendation = recommendation;
            ...
            case level >= 3:
                console.log('P');
                if (Meal != 'No'){
                    recommendation = '• Take an extra insulin dose calculated as 15% of your Total Daily Dose' + '\n' + '• High risk for Diabetes Ketoacidosis (DKA), go to ER' + '\n' + '• Encourage sugar-containing fluids intake (At least 100ml every hour)';
                } else {
                    recommendation = '• Take an extra insulin dose calculated as 15% of your Total Daily Dose' + '\n' + '• High risk for Diabetes Ketoacidosis (DKA), go to ER' + '\n' + '• Encourage sugar-containing fluids intake (At least 100ml every hour)' + '\n' + '• Take a carbohydrate containing snack';
                }
                finalRecommendation = recommendation;
                ...
                case level >= 1 && level <= 1.4:
                    ...
                    if (Meal != 'No'){
                        recommendation = '• Take an extra insulin dose calculated as 10% of your Total Daily Dose' + '\n' + '• Encourage sugar-free fluids intake (At least 100ml every hour)' + '\n' + '• Re-check your blood glucose & Ketone level in 2 hours or sooner if you have hypoglycemia symptoms' + '\n' + '• If you have vomiting & it is persistent, go to ER';
                             ...
                             recommendation = '• Take an extra insulin dose calculated as 10% of your Total Daily Dose' + '\n' + '• Encourage sugar-free containing fluids intake (At least 100ml every hour)' + '\n' + '• Re-check your blood glucose & Ketone level in 2 hours or sooner if you have hypoglycemia symptoms' + '\n' + '• If you have vomiting & it is persistent, go to ER';
                         }
                         finalRecommendation = recommendation;
                    if (flag != 'true'){
                    handleScheduleNotification('iSugar','Time to Re-check your blood glucose & Ketone level.', 120);//120
