...
const notMealTimeAR = ({navigation}) => {
  //==================================================================
  return (
    <LinearGradient colors={['#f5f5f5', '#f5f5f5']} style={styles.container}>
      ...
      <ScrollView style={styles.contView}>
        ...
        <Text style={styles.inpTxt}>
          مستوى سكر الدم عاد إلى المعدل الطبيعي.{'\n'}
           لا تحتاج إلى تناول وجبة خفيفة
          إلا إذا:{'\n'}
           - كان وقت النوم{'\n'}
           - هذا الانخفاض كان أثناء النوم أو بعد الرياضة{'\n'}
           -
          كان لديك انخفاضات متكررة بمستوى سكر الدم خلال هذا اليوم{'\n'}
          - أخذت جرعة
          زائدة من الأنسولين{'\n'}
        </Text>
